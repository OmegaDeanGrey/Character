...
function Valkyrie() {
  ...
  const handleAddToParty = () => {
    ...
    if (party.length < 5) addToParty(valkyrie);
  ...
  return (
    <>
      ...
      <div className="containerdiv4">
        <h1>Valkyrie</h1>
        <h2>Abilty: Winged Halberd Strike</h2>
        <br />
        <typed>Can Not be Countered, Dodged, or Miss.</typed>
        <ul>
          <li>Str: -10</li>
          <li>Int: +10</li>
          <li>Speed: -10</li>
        ...
        {isPartyFull && (
          <div>
            <p id="PFValkyrie">Party Full</p>
          </div> // Disable button if the party is full
        )}
        <button id="ValkyriebttButton" onClick={() => navigate("/TeamIndex")}>
          Back to Team Index
        </button>
      </div>
    </>
