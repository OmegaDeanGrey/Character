...
function DemiGod() {
  ...
  const handleAddToParty = () => {
    ...
    if (party.length < 5) addToParty(demiGod);
  ...
  return (
    <>
      ...
      <div className="containerdiv4">
        <h1>DemiGod</h1>
        <h2>Abilty: Polarity</h2>
        <br />
        <typed>Deals Both Damage and Heals an Ally</typed>
        <ul>
          <li>Str: -10</li>
          <li>Int: +10</li>
          <li>Speed: -10</li>
        ...
        {isPartyFull && (
          <div>
            <p id="PFDemigod">Party Full</p>
          </div> // Disable button if the party is full
        )}
        <button id="DemiGodbttButton" onClick={() => navigate("/TeamIndex")}>
          Back to Team Index
        </button>
      </div>
    </>
