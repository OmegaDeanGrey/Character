...
function Centaur() {
  ...
  const handleAddToParty = () => {
    ...
    if (party.length < 5) addToParty(Centaur);
  ...
  return (
    <>
      ...
      <div className="containerdiv4">
        ...
        <br />
        Centaur ipossess greater than average strength.
        <typed>Centaur </typed>
        <ul>
          <li>Str: -10</li>
          <li>Int: +10</li>
        ...
        {isPartyFull && (
          <div>
            <p id="PFCentaur">Party Full</p>
          </div> // Disable button if the party is full
        )}
        <button id="CentaurbttButton" onClick={() => navigate("/TeamIndex")}>
          Back to Team Index
        </button>
      </div>
    </>
